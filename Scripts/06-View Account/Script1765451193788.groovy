...
WebUI.click(findTestObject('Object Repository/Page_Account Configuration/i_Active_fa fa-eye'))

WebUI.scrollToPosition(10, 0)

WebUI.click(findTestObject('Object Repository/Page_Account Configuration  Detail/a_Back'))

WebUI.click(findTestObject('Object Repository/Page_Account Configuration/span_Agus'))
