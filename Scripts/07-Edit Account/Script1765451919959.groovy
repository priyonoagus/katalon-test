...
WebUI.click(findTestObject('Object Repository/Page_Account Configuration/i_Active_fa fa-pencil'))

WebUI.setText(findTestObject('Object Repository/Page_Account Configuration  Edit/input_Account Number_bank_account_detail-ba_877885'), 
    '5353332277')

WebUI.scrollToPosition(10, 0)

WebUI.setText(findTestObject('Object Repository/Page_Account Configuration  Edit/textarea_Test'), 'Test Edit')

WebUI.click(findTestObject('Object Repository/Page_Account Configuration  Edit/button_Save'))

WebUI.delay(7)

WebUI.click(findTestObject('Object Repository/Page_Account Configuration  Edit/button_OK'))

WebUI.click(findTestObject('Object Repository/Page_Account Configuration/a_Agus'))

WebUI.delay(5)

WebUI.click(findTestObject('Object Repository/Page_Account Configuration/a_Logout'))
